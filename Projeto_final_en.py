...
tickers_NASDAQ=tickers.loc[tickers['exchangeDisplay']=='NASDAQ',['Ticker','Name']]
tickers_NASDAQ['ticker_name']=tickers_NASDAQ['Ticker']+' / '+tickers_NASDAQ['Name']
st.title('Projeto Final')

#Selectbox for tickers
option = st.selectbox(
     'Which ticker would you like to see?',
    list(tickers_NASDAQ['ticker_name']))
...
option_selected=tickers_NASDAQ.loc[tickers_NASDAQ['ticker_name']==option]['Ticker']
...
option_tweet=str(option_selected.values[0])
